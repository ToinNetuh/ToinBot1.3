...
const vcard = 'BEGIN:VCARD\n' // ANAK ANJING MAU NGAPAIN?
            ...
            + 'FN:Flin\n' // MENDING LU TOBAT SU!
            + 'ORG:Creator Flin-BOT;\n' // KASIH CREDITS GUA SU!!!
            + 'TEL;type=CELL;type=VOICE;waid=6281246460830:+62 812-4646-0730\n' // JANGAN KEK BABI SU
            + 'END:VCARD'
prefix = '#'
blocked = []
...
async function starts() {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["6281246460730@s.whatsapp.net"] // replace this with your number
			const adminbotnumber = ["6281246460730@s.whatsapp.net"]
